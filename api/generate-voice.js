...
const STORIES = {
  dragon: {
    ...
    text: 'Жил-был маленький дракон, который не умел дышать огнём. Вместо пламени у него изо рта шёл аромат свежего печенья. Другие драконы смеялись над ним. Но однажды в лесу заблудилась маленькая девочка. Она была голодная и испуганная. Дракон подошёл к ней и выдохнул — и прямо из воздуха появилось тёплое, ароматное печенье. Девочка улыбнулась, и с тех пор они стали лучшими друзьями. А дракон понял: его особенность — это не слабость, а самая настоящая суперсила.'
  },
  moon: {
    title: 'Путешествие на Луну',
    text: 'Однажды ночью маленький мальчик посмотрел в окно и увидел, что Луна грустит. Он построил ракету из подушек и одеял, закрыл глаза — и полетел! На Луне он нашёл лунного зайчика, который потерял свою любимую звёздочку. Мальчик помог ему искать, и они нашли её за самым большим лунным кратером. Зайчик так обрадовался, что подарил мальчику кусочек лунного света. Теперь каждую ночь этот свет мягко горит у мальчика на тумбочке, напоминая: добрые дела светят даже в темноте.'
  }
};
